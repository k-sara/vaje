...
let rec make_move player field =
  ...
  | Field.Coordinate_out_of_bounds ->
    print_endline "Napaka v vnosu koordinat, števila niso primerna"; 
	make_move player field
  | Field.Nonempty_value_at_coordinates ->
    print_endline "Napaka v vnosu koordinat, polje je že polno"; 
	make_move player field
  | Failure msg when msg = "int_of_string" ->
    print_endline "Napaka v vnosu koordinat,, vnesi cela števila"; 
	make_move player field
